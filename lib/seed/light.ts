  ...
  return [
    light(
      ...
      [
        ...
        ['FR-APP-003', 'Assisted refund application', 'The system shall allow a stamp vendor to submit a refund application on behalf of the purchaser after OTP consent from the purchaser\'s mobile number.', 'Given the purchaser enters the OTP, when the vendor submits, then the vendor ID is recorded on the application.', ['GO-2.1'], 'Should', 'Stamp vendor'],
